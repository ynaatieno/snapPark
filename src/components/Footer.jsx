    ...
    return(
        <footer className="bg-[#023047] py-10 my-3">
            ...
            <div className="leading-10 flex-1">
                ...
                <ul>
                    <li className="flex gap-3 items-center mt-2 text-white"><img src="src/assets/email.png " width={40}/><p>contact@clozzet.com</p></li>
                    <li className="flex gap-3 items-center mt-4 text-white"><img src="src/assets/phone.png" width={40}/><p>254-700-333-333</p></li>
